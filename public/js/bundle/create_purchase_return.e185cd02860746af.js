      ...
      for (var i = 0; i < this.details.length; i++) {
        if (this.details[i].detail_id == id) {
          if (detail.quantity - 1 > 0) {
            if (detail.quantity - 1 > detail.purchase_quantity) {
              this.makeToast("warning", this.$t("qty_return_is_greater_than_qty_purchased"), this.$t("Warning")); // this.details[i].quantity = 0;
            } else if (detail.quantity - 1 > detail.stock) {
              this.makeToast("warning", this.$t("qty_return_is_greater_than_Quantity_Remaining"), this.$t("Warning")); // this.details[i].quantity = 0;
            } else {
              this.formatNumber(this.details[i].quantity--, 2);
            }
          }
